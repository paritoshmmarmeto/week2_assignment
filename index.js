document.addEventListener("DOMContentLoaded", function () {
  ...
  function printCurrentSlideSrc() {
    ...
    let color = [
      ...
      "linear-gradient(105.54deg, #ADB0B0 -2.93%, #E1E1E1 72.14%)",
    ...
    fetch("data.json")
      ...
      .then((data) => {
        ...
        document.getElementById("heading").innerText =
          data.sectionBlocks[new_num - 1].heading;
        document.getElementById("subheading").innerText =
          data.sectionBlocks[new_num - 1].subheading;
        document.getElementById("description").innerText =
          data.sectionBlocks[new_num - 1].description;
        document.getElementById("price").innerText =
          data.sectionBlocks[new_num - 1].price;
